...
export function AIControlSidebar({
  ...
  return (
    <aside className="group/sidebar flex w-14 shrink-0 border-l border-[var(--brand-muted)]/25 bg-[var(--brand-surface)] transition-all duration-300 hover:w-80">
      <div className="flex w-14 flex-col items-center gap-3 border-r border-[var(--brand-muted)]/20 py-3">
        <button
          type="button"
          onClick={handleToggleAI}
          disabled={loadingToggleAI}
          title={isDisabled ? "Ativar IA" : "Desativar IA por 1h"}
        ...
        <div className="h-full overflow-y-auto p-3">
          <div className="rounded-xl border border-[var(--brand-muted)]/25 bg-white p-4 shadow-sm">
            ...
            <div className="mt-2 space-y-2">
              ...
              >
                {savingContactData ? <Loader2 className="h-4 w-4 animate-spin" /> : null}
                Salvar nome
              </button>
            </div>
          </div>
