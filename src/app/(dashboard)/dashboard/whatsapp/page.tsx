    ...
    <div className="p-8">
      ...
      <div className="grid gap-6 lg:grid-cols-2">
        ...
        <div className="rounded-xl border border-dashed border-zinc-700 bg-zinc-900/30 p-8">
          <h3 className="font-medium text-zinc-300">Sobre a conexão</h3>
          <p className="mt-2 text-sm text-zinc-500">
            O WhatsApp roda em uma VPS dedicada. Configure a URL da API (Evolution
            ou WAHA) nas variáveis de ambiente. O QR Code será exibido aqui após
            a conexão.
          </p>
        </div>
      </div>
